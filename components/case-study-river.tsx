...
const caseStudies = [
  {
    ...
    tags: ['Next.js', 'M-Pesa', 'Dealer Portal'],
    image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=800&q=80',
    imageAlt: 'Manufacturing facility with modern equipment',
  },
  {
    client: 'Mombasa Continental Resort',
    industry: 'Hospitality',
    result: '127M KES direct bookings',
    brief: 'Booking engine with dynamic pricing, payment integration, and AI concierge.',
    tags: ['Booking System', 'AI Concierge', 'Cards + M-Pesa'],
    image: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80',
    imageAlt: 'Luxury resort architecture and pool',
  },
  {
    client: 'Coast General Hospital',
    industry: 'Healthcare',
    result: '89% appointment automation',
    brief: 'Patient portal with appointment scheduling, records access, and payment processing.',
    tags: ['Patient Portal', 'HIPAA Compliant', 'Automation'],
    image: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&q=80',
    imageAlt: 'Modern hospital building architecture',
  },
]
