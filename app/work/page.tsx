...
const projects = [
  ...
  },
  {
    ...
    brief: 'Telemedicine platform bringing accessible medical consultation to underserved communities. Patient management system.',
    challenge: 'Limited access to healthcare in remote areas. No after-hours consultation. Manual appointment scheduling overwhelming staff.',
    solution: 'Telemedicine platform with video consultation. AI-powered symptom checker. Automated appointment and reminder system.',
    stack: ['Next.js', 'Video API', 'OpenAI', 'Supabase'],
    metrics: [
      { value: '24/7', label: 'Availability' },
      { value: '5K+', label: 'Consultations' },
      { value: 'AI', label: 'Triage Assistant' },
    ],
  },
  {
    id: 'robi',
