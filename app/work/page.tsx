...
const projects = [
  {
    ...
    year: '2024',
    result: '340%',
    resultLabel: 'Traffic Increase',
    brief: 'Authority website rebuild with integrated dealer portal and M-Pesa B2B payments.',
    challenge: 'Zero online presence. Competitors dominating local search. No way for dealers to place orders digitally.',
    solution: 'Authority website with SEO architecture. Dealer portal for order management. Lead capture with automated qualification.',
    stack: ['Next.js', 'Sanity CMS', 'Vercel', 'M-Pesa API'],
    metrics: [
      { value: '340%', label: 'Lead increase' },
      { value: '#1', label: 'Google ranking' },
      { value: '12', label: 'New dealers' },
    ],
  },
  {
    id: 'continental',
    number: '02',
    client: 'Mombasa Continental Resort',
    industry: 'Hospitality',
    year: '2024',
    result: '127M',
    resultLabel: 'KES Direct Bookings',
    brief: 'Booking engine with dynamic pricing, payment integration, and AI concierge.',
    challenge: 'Phone-only bookings limiting capacity. No dynamic pricing capability. Missing international guests.',
    solution: 'Custom booking engine with real-time availability. Multi-currency payment processing. AI concierge for 24/7 guest support.',
    stack: ['Next.js', 'Supabase', 'Stripe', 'OpenAI'],
    metrics: [
      { value: 'KES 127M', label: 'Direct bookings' },
      { value: '45%', label: 'OTA dependency drop' },
  ...
  },
  {
    id: 'coast-general',
    number: '03',
    client: 'Coast General Hospital',
    industry: 'Healthcare',
    year: '2025',
    result: '89%',
    resultLabel: 'Automation Rate',
    brief: 'Patient portal with appointment scheduling, records access, and payment processing.',
    challenge: 'Phone-only booking overwhelming reception. No after-hours patient communication. Manual appointment reminders.',
    solution: 'Online booking system with AI triage assistant. Automated reminders and follow-ups. Patient portal for records access.',
    stack: ['Next.js', 'OpenAI', 'Twilio', 'Supabase'],
    metrics: [
      { value: '89%', label: 'Appointment automation' },
